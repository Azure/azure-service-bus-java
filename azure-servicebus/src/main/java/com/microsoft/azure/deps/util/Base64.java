...
package com.microsoft.azure.deps.util;
...
public final class Base64
{
    ...
    {
        /* Codes_SRS_BASE64_21_002: [If the `base64Values` is null, the decodeBase64 shall throw IllegalArgumentException.] */
        if(base64Values == null)
        {
            throw new IllegalArgumentException("null or empty base64Values");
        }

        /* Codes_SRS_BASE64_21_003: [If the `base64Values` is empty, the decodeBase64 shall return a empty byte array.] */
        if(base64Values.length == 0)
        {
            return new byte[0];
        }

        /* Codes_SRS_BASE64_21_004: [If the `base64Values` length is not multiple of 4, the decodeBase64 shall throw IllegalArgumentException.] */
        if((base64Values.length % BASE64_GROUP_SIZE) != 0)
        {
            throw new IllegalArgumentException("invalid base64Values length");
        }

        /* Codes_SRS_BASE64_21_001: [The decodeBase64 shall decode the provided `base64Values` in a byte array using the Base64 format define in the RFC2045.] */
    ...
    {
        /* Codes_SRS_BASE64_21_006: [If the `dataValues` is null, the encodeBase64 shall throw IllegalArgumentException.] */
        if(dataValues == null)
        {
            throw new IllegalArgumentException("null or empty dataValues");
        }

        /* Codes_SRS_BASE64_21_007: [If the `dataValues` is empty, the encodeBase64 shall return a empty byte array.] */
        if(dataValues.length == 0)
        {
            return new byte[0];
        }

        /* Codes_SRS_BASE64_21_005: [The encodeBase64 shall encoded the provided `dataValues` in a byte array using the Base64 format define in the RFC2045.] */
     ...
     * @throws IllegalArgumentException if the provided base64 values are null, or do not fits the required length
     */
    public static String encodeBase64String(byte[] dataValues) throws IllegalArgumentException
    {
        /* Codes_SRS_BASE64_21_009: [If the `dataValues` is null, the encodeBase64String shall throw IllegalArgumentException.] */
        if(dataValues == null)
        {
            throw new IllegalArgumentException("null or empty dataValues");
        }

        /* Codes_SRS_BASE64_21_010: [If the `dataValues` is empty, the encodeBase64String shall return a empty string.] */
        if(dataValues.length == 0)
        {
            return new String();
        }

        /* Codes_SRS_BASE64_21_008: [The encodeBase64String shall encoded the provided `dataValues` in a string using the Base64 format define in the RFC2045.] */
