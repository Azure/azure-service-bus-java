...
public class AadTokenProviderTests {
	...
	@Test
    public void QueueWithAadTokenProviderTest() throws InterruptedException, ServiceBusException
    {
		...
		managementClient.createQueueAsync(queuePath).join();
	...
	@Test
    public void TopicWithAadTokenProviderTest() throws InterruptedException, ServiceBusException
    {
        if (!shouldRunAuthTests)
        {
            return;
		...
		managementClient.createTopicAsync(topicPath).join();
